<li>
    ...
    <ul>
        ...
        <li> <a href="{{ route('TheAfriChildCoreProgramAreas') }}">Core Programs</a> </li>
        <li> <a href={{ route('AfriChildFounders') }}>Founding Partners</a> </li>
        <li> <a href="{{ route('AfriChildCenterMakerereResearchAssociates') }}">Research Associates</a> </li>
        <li> <a href="{{ route('AfriChildPromotingPartners') }}">Promoting Partners</a> </li>
        <li> <a href="{{ route('AfriChildCenterMakerereAffiliates') }}">Affiliates</a> </li>
...
<div class="d-xl-none d-lg-none  d-md-none ">
    ...
    <li class=""> <a style="font-weight: 400"href="https://www.mak.ac.ug/" target="_blank">Makerere University</a>
    </li>
...
<li>
    <a style="font-weight: 400" href="#">Staff Area</a>
    <ul>
